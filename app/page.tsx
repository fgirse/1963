...
<>
    ...
    <section className="h-[180vh]   w-full py-5 bg-gradient-to-b from-slate-700 to-slate-300 min-h-screen flex flex-col justify-between items-center">
      ...
      <h1 className='mt-[28vh] leading-4  text-center text-sm w-10/12 md:mt-[45vh] md:text-2xl  lg:font-bold  text-orange-500 lg:w-8/12 lg:px-24 lg:mt-[63vh] ' >&ldquo; es sind die menschlichen Begegnungen die das Leben lebenswert gestalten &ldquo;</h1>
      ...
      <p className=" text-center text-4xl text-amber-500  headingA " > &ldquo;Der Ball ist rund&ldquo;</p>
        ...
        <Link href="/Wohin" className="mb-5 -mt-7 text-5xl px-5 py-2 text-white bg-slate-600 hover:bg-amber-500/50 border-2 hover:border-2 rounded-xl">Karte GoogleMaps</Link>
